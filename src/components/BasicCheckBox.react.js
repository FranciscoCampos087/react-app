      ...
      <>
        <ThemeProvider theme={theme}>
          ...
          <Checkbox
            {...label}
            inputProps={{
              "data-id": "purple-radio-button",
              "aria-label": "purple-radio-button",
            }}
            color="secondary"
          />
          <Checkbox
          ...
          <Checkbox
            {...label}
            inputProps={{
              "data-id": "grey-radio-button",
              "aria-label": "grey-radio-button",
            }}
            color="default"
          />
          <Checkbox
            inputProps={{
              "data-id": "red-radio-button",
