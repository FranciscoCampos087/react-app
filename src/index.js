      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route
            exact
            path="/playground"
            component={this.renderPlaygroundForm}
          />
  ...
  renderList = ({ history }) => {
    return (
      <>
        ...
        <div className="App">
          <h1 className="contacts" data-id="contacts">
            Contacts
          </h1>
  ...
  renderCreateForm = ({ history }) => {
    return (
      <>
        ...
        <div className="App">
          <h1 data-id="create-contact-header" className="create-contact">
            Create Contact
          </h1>
          <ContactForm
            contact={null}
              ...
              <div className="row flow-offset-1">
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Radio Button</span>
                    </h2>
                  </div>
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Check Box</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicCheckBox />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Card</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicCard />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Switch</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicSwitch />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Buttons</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicButtons />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Avatars</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicAvatars />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Open Tab</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicTab />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Drop Down Menu</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicMenu />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Text Area</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicTextArea />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Table</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicTable />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Tooltip</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicTooltip />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Alert</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicAlert />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Open Window</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicOpenWindow />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Browser Alert</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicBrowserAlert />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Show / Hide</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicShowHide />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Select</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicSelect />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Badge</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicValidation />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">IFrame</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicIframe />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Stored Values</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicStoredValues />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Index</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicIndex />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Basic Values</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicValues />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Input Values</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicInputValues />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Login</span>
                    </h2>
                  </div>
                  <div className="product tumbnail thumbnail-3">
                    <BasicLogin />
                ...
                <div className="col-xs-6 col-md-4">
                  <div className="caption">
                    <h2>
                      <span className="caption-text">Basic REST</span>
                    </h2>
                  </div>
